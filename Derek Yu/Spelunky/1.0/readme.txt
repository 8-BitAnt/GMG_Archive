...
slot and then enable gamepads when the game starts.
           ...
           USB
            |
  LT        |       RT     Left Trigger  - [None by Default]
            |              Left Bumper   - Bomb Shortcut
  ___LB     |     RB___    Right Trigger - Cycle Whip, Item, Bombs, Rope
 /     \____=____/     \   Right Bumper  - Rope Shortcut
.                       .  D-Pad         - Move
|   |   9      10   4   |  Button 10     - Pause/Menu (Quit Game)
|  = =             1 3  |  Button 1      - Whip, Throw Item, Use Item
|   |               2   |  Button 2      - Jump
|                       |  Button 3      - Run
|      LA       RA      |  Button 4      - Purchase/Bet
...
1. The game just ends immediately after the setup screen!

- Your graphics card may not be compatible with Game Maker surfaces, which
  Spelunky uses.  Try running the game with fullscreen "off" and see if that
  helps.

2. There are strange visual glitches in the game.

- That is probably another graphics card issue.  I am looking into it.

3. The game runs slowly on my computer!

- Try turning "High Detail" off when the game loads, or closing other programs
  that are running.

4. This game is too hard!
...
5. Any plans to port the game to [game console]?

- Spelunky is coming to XBLA in 2010!  Visit www.spelunkyworld.com for info.

6. When will you release the source code (.gmk file)?

- The source code will be made available before 2010 on the above site.

7. I have something to tell you about the game!

- I'd love to hear it!  Contact me at yu.derek@gmail.com.

8. I'd like to donate some money to you for Spelunky.

- Well, thanks!  That means a lot to me.  But instead, please check out my
other games at my website www.derekyu.com. :)

=========================
 LICENSE
=========================

Spelunky, which includes the executable, sound files, and this readme, is
...
Overmars' Game Maker 7.0 (http://www.yoyogames.com/make). 
...
This game incorporates ChevyRay's SCREEN-SCALING SCRIPTS.
